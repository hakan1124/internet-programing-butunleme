...
<body>
    ...
    <section class="container">
        <div class="row mt-5 mb-5">
            <div class="col">
                <div class="card">
                    <img style="height:20rem;" src="
                    <?php
                        print $oldeventQuery1["oldevent_img"]
                    ?>
                    " class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
                                print $oldeventQuery1["oldevent_header"]
                            ?>
                        </h5>
                        <p class="card-text"> <?php
                                print $oldeventQuery1["oldevent_text"]
                            ?> </p>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery1["oldevent_first_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery1["oldevent_second_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery1["oldevent_third_item"]
                            ?>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col">
                <div class="card ">
                    <img style="height:20rem;" src="
                    <?php
                        print $oldeventQuery2["oldevent_img"]
                    ?>
                    " class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
                                print $oldeventQuery2["oldevent_header"]
                            ?>
                        </h5>
                        <p class="card-text"> <?php
                                print $oldeventQuery2["oldevent_text"]
                            ?> </p>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery2["oldevent_first_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery2["oldevent_second_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery2["oldevent_third_item"]
                            ?>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <img style="height:20rem;" src="
                    <?php
                        print $oldeventQuery3["oldevent_img"]
                    ?>
                    " class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
                                print $oldeventQuery3["oldevent_header"]
                            ?>
                        </h5>
                        <p class="card-text"> <?php
                                print $oldeventQuery3["oldevent_text"]
                            ?> </p>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery3["oldevent_first_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery3["oldevent_second_item"]
                            ?>
                        </li>
                        <li class="list-group-item">
                        <?php
                                print $oldeventQuery3["oldevent_third_item"]
                            ?>
                        </li>
                    </ul>
                </div>
